...
class AdApi
{
     ...
     * @param  string|array $status status (optional)
     * @param  string|array $transactionCode transactionCode (optional)
     * @param  string|array $productTypeCode productTypeCode (optional)
     ...
     */
    public function getAdCollection($page = '1', $advertiserId = null, $advertiserCode = null, $reference = null, $parentAdId = null, $createdAtBefore = null, $createdAtAfter = null, $updatedAtBefore = null, $updatedAtAfter = null, $status = null, $transactionCode = null, $productTypeCode = null, $transactionPriceGte = null, $transactionPriceLte = null)
    {
        list($response) = $this->getAdCollectionWithHttpInfo($page, $advertiserId, $advertiserCode, $reference, $parentAdId, $createdAtBefore, $createdAtAfter, $updatedAtBefore, $updatedAtAfter, $status, $transactionCode, $productTypeCode, $transactionPriceGte, $transactionPriceLte);
        return $response;
    }
     ...
     * @param  string|array $status (optional)
     * @param  string|array $transactionCode (optional)
     * @param  string|array $productTypeCode (optional)
     ...
     */
    public function getAdCollectionWithHttpInfo($page = '1', $advertiserId = null, $advertiserCode = null, $reference = null, $parentAdId = null, $createdAtBefore = null, $createdAtAfter = null, $updatedAtBefore = null, $updatedAtAfter = null, $status = null, $transactionCode = null, $productTypeCode = null, $transactionPriceGte = null, $transactionPriceLte = null)
    {
        $returnType = '\Ubiflow\Model\AdAdRead[]';
        $request = $this->getAdCollectionRequest($page, $advertiserId, $advertiserCode, $reference, $parentAdId, $createdAtBefore, $createdAtAfter, $updatedAtBefore, $updatedAtAfter, $status, $transactionCode, $productTypeCode, $transactionPriceGte, $transactionPriceLte);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdCollectionAsync($page = '1', $advertiserId = null, $advertiserCode = null, $reference = null, $parentAdId = null, $createdAtBefore = null, $createdAtAfter = null, $updatedAtBefore = null, $updatedAtAfter = null, $status = null, $transactionCode = null, $productTypeCode = null, $transactionPriceGte = null, $transactionPriceLte = null)
    {
        return $this->getAdCollectionAsyncWithHttpInfo($page, $advertiserId, $advertiserCode, $reference, $parentAdId, $createdAtBefore, $createdAtAfter, $updatedAtBefore, $updatedAtAfter, $status, $transactionCode, $productTypeCode, $transactionPriceGte, $transactionPriceLte)
            ->then(
                function ($response) {
                    return $response[0];
                }
