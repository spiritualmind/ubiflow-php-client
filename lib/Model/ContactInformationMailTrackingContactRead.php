<?php
/**
 * ContactInformationMailTrackingContactRead
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ContactInformationMailTrackingContactRead Class Doc Comment
 *
 * @category Class
 * @package  Ubiflow
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactInformationMailTrackingContactRead implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactInformation-mail_tracking_contact.read';
    ...
    protected static $swaggerTypes = [
        ...
        'email' => 'string',
        'phone' => 'string',
        'postalAddress' => '\Ubiflow\Model\PostalAddressMailTrackingContactRead',
        'situation' => 'string',
        'society' => 'string',
        'programName' => 'string',
     ...
     * Gets postalAddress
     *
     * @return \Ubiflow\Model\PostalAddressMailTrackingContactRead
     */
     ...
     * Sets postalAddress
     *
     * @param \Ubiflow\Model\PostalAddressMailTrackingContactRead $postalAddress postalAddress
     *
     * @return $this
     */
