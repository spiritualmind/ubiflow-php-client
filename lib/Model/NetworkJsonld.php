...
/**
 * NetworkJsonld Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NetworkJsonld implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Network.jsonld';
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
        'type' => 'string',
        'context' => 'OneOfNetworkJsonldContext',
        'id' => 'int',
        'code' => 'string',
        'name' => 'string',
        'externalServiceCode' => ''
     ...
     * Gets context
     *
     * @return OneOfNetworkJsonldContext
     */
     ...
     * Sets context
     *
     * @param OneOfNetworkJsonldContext $context context
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param int $id The unique identifier of the network, in the Ubiflow IS.
     *
     * @return $this
     */
    public function setId($id)
     ...
     * Sets code
     *
     * @param string $code The unique code of the network, in the Ubiflow IS.
     *
     * @return $this
     */
